...
function executeQueryFile($filesql, $db) {
...
$form = " <div class=\"text-center\" style=\"padding:50px 0; margin-left: 40%;\">
            ...
            <div class=\"logo\">Base de donn&eacute;e:&nbsp;</div>
            <!-- Main Form -->
...
if (file_exists($file)) {
    ...
    echo "L'installation est terminée. Veuillez supprimer ce fichier et acc&eacute;der à <a href='/'> l'acceuil</a>";
    exit(1);
} else {
